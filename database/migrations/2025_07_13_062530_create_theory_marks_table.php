...
return new class extends Migration
{
    ...
    {
        Schema::create('theory_marks', function (Blueprint $table) {
           $table->id();
            ...
            $table->integer('participation')->default(0); // attendance
            $table->integer('ct')->default(0);
            $table->integer('semester_final')->default(0);
    ...
    {
        Schema::dropIfExists('theory_marks');
    }
};
