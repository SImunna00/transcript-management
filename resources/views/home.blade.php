    ...
    <style>
        .hero-section {
            background: linear-gradient(135deg, rgba(0, 123, 255, 0.7), rgba(40, 167, 69, 0.7)),
                url('{{ asset('assests/image/campus-background.jpg') }}');
        ...
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="lead text-muted">Experience the future of academic record management with our comprehensive
                        platform</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-text">Your academic records are protected with bank-level security encryption and
                            secure payment processing through SSLCommerz.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-text">Quick result processing and instant notifications. Get your transcripts
                            processed efficiently with minimal waiting time.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-text">Access your results from any device. Our responsive design ensures perfect
                            functionality on mobile, tablet, and desktop.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-text">Secure online payments with multiple payment options. Pay for your
                            transcript requests safely and conveniently.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-text">Download your approved results instantly. Access your transcripts 24/7 once
                            they're processed and approved.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-text">Round-the-clock customer support to help you with any queries or issues
                            regarding your transcript requests.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="cta-text">Join thousands of students who trust our platform for their academic record
                        management</p>
...
@if(config('app.debug'))
    ...
    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 1000">
        <div class="dropdown">
            <button class="btn btn-sm btn-dark dropdown-toggle" type="button" id="devToolsDropdown"
                data-bs-toggle="dropdown">
                <i class="fas fa-tools"></i> Dev Tools
            </button>
            <ul class="dropdown-menu" aria-labelledby="devToolsDropdown">
                <li><a class="dropdown-item" href="{{ url('QUICK_NAVIGATION.md') }}" target="_blank">Quick Navigation
                        Guide</a></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li>
                    <h6 class="dropdown-header">Current Image</h6>
                </li>
                <li><a class="dropdown-item" href="{{ asset('assests/image/campus-background.jpg') }}" target="_blank">View
                        Background Image</a></li>
                <li><a class="dropdown-item" href="#" onclick="window.open('{{ asset('assests/image') }}', '_blank')">Open
                        Images Folder</a></li>
            </ul>
        </div>
    </div>
