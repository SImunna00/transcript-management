                            ...
                            <tbody>
                                @foreach($requests as $request)
                                    <tr>
                                        ...
                                        <td>
                                            <i class="fas fa-university text-secondary mr-1"></i>
                                            {{ $request->session ?? 'N/A' }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                @if($request->payment_status === 'pending' || $request->payment_status === 'failed')
                                                    <a href="{{ route('payment.initiate.retry', $request->id) }}"
                                                ...
                                                @if($request->payment_status === 'paid' && ($request->result_file || $request->transcript_path))
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <strong>Session:</strong> {{ $request->session ?? 'N/A' }}<br>
                                                    ...
                                                    @endif
                                                    @if($request->result_file || $request->transcript_path)
                                                        <hr>
                                                        <strong>Result File:</strong>
                                                        <span class="text-success">
                                                            <i class="fas fa-file-pdf"></i> Available for Download
                                                        </span>
                                                    @endif
                                                </div>
